          ...
          <div className="space-y-8 py-3">
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-2.5 px-1">
                ...
                <label className="text-sm text-slate-800 font-bold tracking-wide">
                  संदर्भ विशिष्ट रणनीतिक परिदृश्य <span className="text-slate-400 font-normal ml-1">(Select Context Template)</span>
                </label>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2.5 px-1">
                ...
                <label className="text-sm text-slate-800 font-bold tracking-wide">
                  स्थानीय पुलिस बल एवं अतिरिक्त भौगोलिक विनिर्देश <span className="text-slate-400 font-normal ml-1">(Optional Details)</span>
                </label>
              </div>
              <textarea
                value={localDetails}
