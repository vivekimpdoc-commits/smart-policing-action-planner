      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-5">
        ...
        {activeTab === "ai-advisor" && (
          <div className="space-y-6">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-900 via-blue-900 to-indigo-800 p-5 shadow-lg">
              ...
              <div className="relative flex items-start gap-4 z-10">
                <div className="p-3 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-sm">
                  <Sparkles className="w-6 h-6 text-indigo-100" />
                </div>
                <div className="space-y-1.5 mt-0.5">
                  <h4 className="text-sm font-black text-white uppercase tracking-widest drop-shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 px-1">
                <div className="flex items-center justify-center w-5 h-5 rounded-full bg-indigo-100 text-indigo-700 font-bold text-[10px]">1</div>
                <label className="text-xs text-slate-700 font-bold uppercase tracking-wider">
                  संदर्भ विशिष्ट रणनीतिक परिदृश्य <span className="text-slate-400 font-normal normal-case">(Select Context Template):</span>
                </label>
              </div>
                ...
                {sector.aiScenarios.map((sc, scIdx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group relative p-4 text-left rounded-2xl border transition-all duration-300 flex flex-col justify-between h-28 cursor-pointer overflow-hidden ${
                        isSelected 
                          ? "bg-gradient-to-br from-indigo-600 to-blue-700 border-transparent shadow-lg shadow-indigo-600/20 ring-2 ring-indigo-500 ring-offset-2" 
                          : "bg-white border-slate-200 hover:border-indigo-300 hover:shadow-md hover:-translate-y-0.5"
                      }`}
                    >
                      {/* Decorative background blur for selected state */}
                      {isSelected && (
                      ...
                      <div className="relative z-10 flex flex-col h-full gap-1.5">
                        <span className={`font-bold text-sm leading-tight ${isSelected ? "text-white" : "text-slate-800 group-hover:text-indigo-700 transition-colors"}`}>
                          {sc.label}
                        </span>
                        <span className={`text-[11px] line-clamp-2 leading-relaxed ${isSelected ? "text-indigo-100/90" : "text-slate-500"}`}>
                          {sc.context}
                        </span>
                      </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 px-1">
                <div className="flex items-center justify-center w-5 h-5 rounded-full bg-indigo-100 text-indigo-700 font-bold text-[10px]">2</div>
                <label className="text-xs text-slate-700 font-bold uppercase tracking-wider">
                  स्थानीय पुलिस बल एवं अतिरिक्त भौगोलिक विनिर्देश <span className="text-slate-400 font-normal normal-case">(Optional Local Details):</span>
                </label>
              </div>
              <div className="relative group">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-indigo-300 to-blue-300 rounded-2xl blur opacity-0 group-hover:opacity-30 transition duration-500 pointer-events-none"></div>
                <textarea
                  value={localDetails}
                  ...
                  className="relative w-full bg-white/90 backdrop-blur-sm border border-slate-200 p-4 rounded-2xl text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 resize-none transition-all shadow-sm"
                />
              </div>
            </div>
            ...
            <button
              ...
              disabled={loadingAI}
              className="relative overflow-hidden w-full group rounded-2xl p-4 font-bold text-sm flex items-center justify-center gap-3 transition-all cursor-pointer disabled:cursor-not-allowed shadow-lg shadow-indigo-600/20 border-none"
            >
              <div className={`absolute inset-0 transition-all duration-300 ${loadingAI ? 'bg-slate-100 border border-slate-200' : 'bg-gradient-to-r from-indigo-600 via-blue-600 to-indigo-700 group-hover:bg-gradient-to-r group-hover:from-indigo-700 group-hover:via-blue-700 group-hover:to-indigo-800'}`}></div>
              ...
              <div className="relative z-10 flex items-center justify-center gap-2 w-full">
                {loadingAI ? (
                  <>
                    ...
                    <span className="text-slate-600 font-bold tracking-wide">SOP जनरेट की जा रही है...</span>
                  </>
                ) : (
                  <>
                    ...
                    <span className="text-white tracking-wide uppercase font-extrabold drop-shadow-sm">राजकीय विधिक रणनीति तैयार करें <span className="font-semibold normal-case text-indigo-100">(Formulate AI Strategy)</span></span>
                  </>
                )}
              </div>
            </button>
                  ...
                  <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-extrabold text-indigo-900 uppercase tracking-wider">
                        राजकीय नीति ड्राफ्ट: <span className="text-slate-600 font-bold">{activeScenario.label}</span>
                      </span>
                    </div>
