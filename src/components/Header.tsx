...
import { ShieldAlert, Scale, Landmark, Printer, BarChart3, RotateCcw } from "lucide-react";
...
export function Header({ overallProgress, viewMode, setViewMode, onPrint, onReset }: HeaderProps) {
  return (
        ...
        <div className="flex flex-wrap items-center gap-3 sm:gap-4 justify-start md:justify-end">
          ...
          <div className="hidden lg:flex gap-5 text-right border-r border-slate-200 pr-5">
            <div>
              ...
              <p className="text-xs text-slate-700 font-mono font-medium">ZONE-07 ALPHA</p>
            </div>
            <div>
              <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider">Status</p>
              <p className="text-xs text-emerald-600 font-mono font-bold flex items-center gap-1.5 justify-end">
